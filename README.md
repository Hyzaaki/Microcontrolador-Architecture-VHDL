...
| Projeto              | Nome da Pasta                              | Descrição                                                                               |
| :------------------- | :----------------------------------------- | :---------------------------------------------------------------------------------------- |
| **Projeto 01** | `01-ALU-e-Mux-de-Enderecos`              | Lógica combinacional pura: ALU de 16 operações e Multiplexador de Endereços.          |
| **Projeto 02** | `02-Registradores-e-Unidade-de-Controle` | Lógica sequencial: Registradores (W, FSR, STATUS) e Contador de Programa (PC) com Pilha. |
| **Projeto 03** | `03-Interface-IO-e-Memoria-RAM`          | Integração de Periféricos: Interface de I/O paralela e Memória RAM mapeada em bancos. |

---

**Desenvolvido por Isaac Alves Schuenck e Rodrigo Pretes Maia**
